...
// rewamp: __arm64__ is Apple-only; Android/Linux arm64 clang defines __aarch64__
// instead, which would have fallen through to MSB_FIRST on a little-endian CPU.
#if defined(__arm64__) || defined(__aarch64__) || defined(__i386__) || defined(__i486__) || defined(__i586__) || defined(__i686__) || defined(__x86_64__) || defined(__alpha__) || defined(__MIPSEL__) || defined(_M_IX86) || defined(_M_X64)
#define LSB_FIRST
