...
/* Android NDK ships no libbz2 — disable bzip2 filter there (7z/zip use lzma/zlib). */
#ifndef __ANDROID__
...
/* Android (bionic) has no standalone iconv before API 28 — disable there. */
#ifndef __ANDROID__
#define HAVE_ICONV 1
#endif
...
/* ---- Additions for liblzma (sysdefs.h / mythread.h need these) ----
   macOS and iOS always have stdbool.h, _Bool, and pthreads.           */
...
#  define HAVE__BOOL 1
#endif
/* Use POSIX threads (pthreads) for multi-threaded xz encode/decode. */
#ifndef MYTHREAD_POSIX
#  define MYTHREAD_POSIX 1
#endif
/* ---- liblzma filter decoder/encoder registration ----
   filter_decoder.c gates each entry on HAVE_DECODER_foo; without these
   the decoder table is empty and lzma_properties_decode returns
   LZMA_OPTIONS_ERROR for every 7z/xz stream.                          */
#ifndef HAVE_DECODERS
#  define HAVE_DECODERS 1
#endif
#ifndef HAVE_DECODER_LZMA1
#  define HAVE_DECODER_LZMA1 1
#endif
#ifndef HAVE_DECODER_LZMA2
#  define HAVE_DECODER_LZMA2 1
#endif
#ifndef HAVE_DECODER_DELTA
#  define HAVE_DECODER_DELTA 1
#endif
#ifndef HAVE_DECODER_X86
#  define HAVE_DECODER_X86 1
#endif
#ifndef HAVE_DECODER_ARM
#  define HAVE_DECODER_ARM 1
#endif
#ifndef HAVE_DECODER_ARM64
#  define HAVE_DECODER_ARM64 1
#endif
#ifndef HAVE_DECODER_ARMTHUMB
#  define HAVE_DECODER_ARMTHUMB 1
#endif
#ifndef HAVE_DECODER_POWERPC
#  define HAVE_DECODER_POWERPC 1
#endif
#ifndef HAVE_DECODER_IA64
#  define HAVE_DECODER_IA64 1
#endif
#ifndef HAVE_DECODER_SPARC
...
#endif
#ifndef HAVE_ENCODER_LZMA2
#  define HAVE_ENCODER_LZMA2 1
#endif

/* EFTYPE est une valeur errno BSD: elle existe sur Darwin, PAS sur Linux —
   ni bionic ni la glibc. On la mappe sur un équivalent raisonnable pour que
   les lecteurs d'archives compilent. Apple n'est pas concerné. */
...
/* ===== Overrides Linux (ajoutés): neutralisent les hypothèses macOS =====
   Ce config.h est GÉNÉRÉ sur macOS; le bloc ci-dessous est appliqué en DERNIER
   pour qu'il l'emporte sur les defines automatiques. Il couvre bionic ET la
   glibc (__ANDROID__ implique __linux__): les deux partagent l'essentiel des
   écarts avec Darwin — pas de CommonCrypto, pas de st_birthtime, pas d'ACL
   POSIX.1e façon Darwin, pas de copyfile, pas de xattr Darwin. Les rares
   points où la glibc diffère de bionic sont traités dans le bloc suivant.
   ===== */
#ifdef __linux__
/* No CommonCrypto / LibSystem digest backends on bionic. */
...
/* bionic stat: st_mtim.tv_nsec, no *timespec / birthtime. */
...
/* No POSIX.1e ACLs, copyfile, or <sys/acl.h> on Android. */
#  undef HAVE_SYS_ACL_H
#  undef HAVE_COPYFILE_H
#  undef HAVE_STRUCT_STAT_ST_FLAGS
#  undef HAVE_STRUCT_STATFS_F_IOSIZE
/* posix_spawn is API 28+; fall back to vfork/fork for program filters. */
#  undef HAVE_POSIX_SPAWNP
#  undef HAVE_SPAWN_H
/* bionic: no lchmod; disable xattr (extraction does not need it). */
#  undef HAVE_LCHMOD
...
#  undef HAVE_GETXATTR
#  undef HAVE_SETXATTR
/* no libxml2 (xar) or libcharset (locale_charset) on Android. */
...
/* ===== glibc uniquement: ce que bionic n'avait pas besoin qu'on corrige ===== */
#if defined(__linux__) && !defined(__ANDROID__)
/* chflags/lchflags sont BSD/Darwin: la glibc ne les a pas. */
#  undef HAVE_CHFLAGS
#  undef HAVE_LCHFLAGS
/* Note: le bloc __linux__ ci-dessus retire aussi posix_spawn et lchmod, que la
   glibc possède pourtant. C'est sans conséquence — libarchive a un repli
   fork/exec et un repli chmod pour les deux — et ça garde UN seul bloc à
   maintenir. iconv et bzlib, eux, restent actifs sur glibc (gardés par un
