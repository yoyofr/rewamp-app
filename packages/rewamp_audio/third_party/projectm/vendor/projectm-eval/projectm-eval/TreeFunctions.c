 ...
 */
#include <float.h>
/* rewamp: MAXFLOAT est un heritage BSD que Darwin expose depuis <math.h>.
 * La glibc ne le declare que sous __USE_MISC, donc pas ici. FLT_MAX est
 * son equivalent normalise et vaut exactement la meme chose. */
#ifndef MAXFLOAT
