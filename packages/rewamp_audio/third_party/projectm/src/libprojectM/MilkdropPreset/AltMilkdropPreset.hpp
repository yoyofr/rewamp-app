...
public:
    ...
    void SetRandomTextures(uint64_t seed, const std::map<int, std::string>& resolvedFiles) override;
    void GetRandomTextures(uint64_t& seed, std::map<int, std::string>& resolvedFiles) const override;
