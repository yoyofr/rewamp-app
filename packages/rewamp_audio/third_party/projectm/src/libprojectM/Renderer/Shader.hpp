...
public:
    ...
    /**
     * @brief The GL program id (rewamp: needed to pre-create the Metal pipeline
     *        state of the transition shaders on the preload thread).
     */
    auto ProgramId() const -> uint32_t { return m_shaderProgram; }
