/* SFORMAT construction macros — verbatim from beetle-wswan (they only build
 * table entries, nothing to strip). */
#ifndef REWAMP_WSWAN_STATE_INLINE_H
#define REWAMP_WSWAN_STATE_INLINE_H
