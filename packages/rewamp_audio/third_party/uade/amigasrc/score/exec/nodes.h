...
struct  __attribute__((__packed__)) Node {
    ULONG   ln_Succ;   /* amiga ptr */	/* Pointer to next (successor) */
    ULONG   ln_Pred;   /* amiga ptr */	/* Pointer to previous (predecessor) */
    UBYTE   ln_Type;
    BYTE    ln_Pri;		/* Priority, for sorting */
    ULONG   ln_Name;   /* amiga ptr */		/* ID string, null terminated */
};	/* Note: word aligned */

/* minimal node -- no type checking possible */
struct  __attribute__((__packed__)) MinNode {
    ULONG mln_Succ;   /* amiga ptr */
    ULONG mln_Pred;   /* amiga ptr */
};
