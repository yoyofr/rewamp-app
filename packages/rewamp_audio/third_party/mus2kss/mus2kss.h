...
/* REWAMP: déclarations manquantes de l'amont — les deux fonctions existent
 * dans mus2kss.c mais n'étaient pas exposées, alors que la conversion AVEC
 * percussions est le cas nominal (le .MUS nomme son kit .SM1/.SM2 voisin). */
