...
// Defining TU (musyx.c only has the extern decl + sets it to 1 when a MusyX
// ucode is detected); upstream Modizer never defines this in the vendored
// tree itself, presumably storage-allocated by app-level glue there.
char mdz_usf_uses_musyx = 0;
//YOYOFR
