/* rewamp: the only edit to the vendored ProWizard sources — the three
 * includes below point at libxmp's internals; rewamp supplies its own
 * minimal replacements right here. Everything else is upstream libxmp. */
#ifndef PROWIZ_H
#define PROWIZ_H
