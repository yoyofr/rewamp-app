...
namespace Module
{
  ...
  //YOYOFR (rewamp) — models collected as the renderer is built, for the pattern
  //visualizer. Clear before creating a renderer, read after; a TurboSound pair
  //yields two, in chip order.
